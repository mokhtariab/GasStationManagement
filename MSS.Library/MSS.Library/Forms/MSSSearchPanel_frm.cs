...
namespace MSS.Library.Forms
{
    public partial class MSSSearchPanel_frm : Form
    {
        ...
        public MSSSearchPanel_frm(MSS.Library.Control.MSSGridexView GridViewEnter)
        {
            InitializeComponent();
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (System.Windows.Forms.Control fg in tableLayoutPanelVisit.Controls)
            {
                ...
                {
                    MSS.Library.Clasess.MSSMessage.MSSMessage_View((fg as UserControls.MSSSearch_UC).MessageResultStateDrugs, Library.Clasess.MSSMessage.MessageType.SError);
                    return;
                }
